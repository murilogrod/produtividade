...
export class AlertMessageService {
  ...
  @Output() alertMessagesErrorChanged: EventEmitter<string[]> = new EventEmitter<string[]>();
  @Output() alertMessagesSucessChanged: EventEmitter<string[]> = new EventEmitter<string[]>();
  @Output() alertMessagesInfoChanged: EventEmitter<string[]> = new EventEmitter<string[]>();
  @Output() alertMessagesWarningChanged: EventEmitter<string[]> = new EventEmitter<string[]>();
