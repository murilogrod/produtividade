...
public class SifrcException extends RuntimeException {
    ...
    public SifrcException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SifrcException(String mensagem, Throwable causa, boolean servicoDisponivel) {
