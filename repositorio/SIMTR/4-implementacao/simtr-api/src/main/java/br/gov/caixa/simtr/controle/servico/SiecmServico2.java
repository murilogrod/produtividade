...
import br.gov.caixa.simtr.controle.servico.helper.SiecmObjetosHelper2;
...
public class SiecmServico2 {

    @EJB
    private GEDService gedService;

    @EJB
    private SiecmObjetosHelper2 siecmObjetosHelper;
    ...
    private static final Logger LOGGER = Logger.getLogger(SiecmServico2.class.getName());
