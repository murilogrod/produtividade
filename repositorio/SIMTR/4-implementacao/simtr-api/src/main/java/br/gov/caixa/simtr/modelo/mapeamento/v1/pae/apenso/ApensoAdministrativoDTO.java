...
@ApiModel(
        value = ConstantesPAE.VISAO_APENSO_API_MODEL_APENSO_ADMINISTRATIVO,
        description = "Objeto utilizado para representar o Apenso Adminstrativo no retorno as consultas realizadas sob a otica da consulta pelo Apenso."
)
public class ApensoAdministrativoDTO implements Serializable {
    ...
    @XmlElement(name = ConstantesPAE.PROCESSO_ADMINISTRATIVO)
    @ApiModelProperty(name = ConstantesPAE.PROCESSO_ADMINISTRATIVO, required = false, value = "Objeto que representa o Processo Administrativo de vinculação do apenso.")
    private ProcessoAdministrativoDTO processoAdministrativoDTO;

    @JsonInclude(JsonInclude.Include.NON_NULL)
    @XmlElement(name = ConstantesPAE.CONTRATO_ADMINISTRATIVO)
    @ApiModelProperty(name = ConstantesPAE.CONTRATO_ADMINISTRATIVO, required = false, value = "Objeto que representa o Contrato Administrativo de vinculação do apenso.")
    private ContratoAdministrativoDTO contratoAdministrativoDTO;
    ...
    @ApiModelProperty(name = ConstantesPAE.AUTORIZADAS, required = false, value = "Lista de unidades autorizadas a manipular o apenso.")
    ...
    public ApensoAdministrativoDTO(ApensoAdministrativo apenso) {
        ...
        if (apenso.getProcessoAdministrativo() != null) {
            this.processoAdministrativoDTO = new ProcessoAdministrativoDTO(apenso.getProcessoAdministrativo());
        }

        if (apenso.getContratoAdministrativo() != null) {
            this.contratoAdministrativoDTO = new ContratoAdministrativoDTO(apenso.getContratoAdministrativo());
        }
    ...
    public ProcessoAdministrativoDTO getProcessoAdministrativoDTO() {
        return processoAdministrativoDTO;
    }

    public void setProcessoAdministrativoDTO(ProcessoAdministrativoDTO processoAdministrativoDTO) {
        this.processoAdministrativoDTO = processoAdministrativoDTO;
    }

    public ContratoAdministrativoDTO getContratoAdministrativoDTO() {
        return contratoAdministrativoDTO;
    }

    public void setContratoAdministrativoDTO(ContratoAdministrativoDTO contratoAdministrativoDTO) {
        this.contratoAdministrativoDTO = contratoAdministrativoDTO;
    }
