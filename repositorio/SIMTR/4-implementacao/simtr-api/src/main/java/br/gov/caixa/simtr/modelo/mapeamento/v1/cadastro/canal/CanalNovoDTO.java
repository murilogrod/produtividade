...
@ApiModel(
        value = ConstantesCadastroCanal.API_MODEL_CANAL_NOVO,
        description = "Objeto utilizado para representar um novo canal de comunicação no envio de inclusão sob a ótica dos cadastros."
)
public class CanalNovoDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesCadastroCanal.INDICADOR_OUTORGA_SIRIC, required = true, value = "Atributo utilizado para indicar se o canal possui permisão ou não de consumo dos serviços do SIRIC expostos diretamente na API do SIMTR em um endpoint de ponte.")
    ...
    public Canal prototype() {
        ...
        canal.setClienteSSO(nomeClienteSSO);
        canal.setJanelaExtracaoM0(this.indicadorJanelaM0);
        canal.setJanelaExtracaoM30(this.indicadorJanelaM30);
        canal.setJanelaExtracaoM60(this.indicadorJanelaM60);
        canal.setIndicadorAvaliacaoAutenticidade(this.indicadorAvaliacaoAutenticidade);
        canal.setIndicadorOutorgaReceita(this.indicadorOutorgaCadastroReceita);
        canal.setIndicadorOutorgaCadastroCaixa(this.indicadorOutorgaCadastroCaixa);
        canal.setIndicadorAtualizacaoDocumento(this.indicadorAtualizacaoDocumental);
        canal.setIndicadorOutorgaApimanager(this.indicadorOutorgaApimanager);
        canal.setIndicadorOutorgaSiric(this.indicadorOutorgaSiric);
        canal.setUrlCallbackDocumento(this.urlCallbackDocumento);
        canal.setUrlCallbackDossie(this.urlCallbackDossie);
        canal.setUnidadeCallbackDossie(this.unidadeCallbackDossie);
