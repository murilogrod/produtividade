...
@ApiModel(
        value = ConstantesCadastroTipoDocumento.API_MODEL_ATRIBUTO_EXTRACAO__PROCESSOADMINISTRATIVO,
...
public class AtributoExtracaoDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesCadastroTipoDocumento.NOME_NEGOCIAL, required = true, value = "Valor a ser utilizado como label do formulario utilizado nos casos de captura manual.")
    private String nomeNegocial;

    @XmlElement(name = ConstantesCadastroTipoDocumento.NOME_INTEGRACAO)
    @ApiModelProperty(name = ConstantesCadastroTipoDocumento.NOME_INTEGRACAO, required = true, value = "Valor a ser utilizado como chave do atributo utilizado na integrações para identificação do campo perante o envio e recepção de informações do documento.")
    private String nomeIntegracao;

    @XmlElement(name = ConstantesCadastroTipoDocumento.TIPO_CAMPO)
    @ApiModelProperty(name = ConstantesCadastroTipoDocumento.TIPO_CAMPO, required = true, value = "Definição sobre a forma de apresentar o campo para captura da informação do documento.")
    private TipoCampoEnum tipoCampo;

    @XmlElement(name = ConstantesCadastroTipoDocumento.INDICADOR_OBRIGATORIO)
    @ApiModelProperty(name = ConstantesCadastroTipoDocumento.INDICADOR_OBRIGATORIO, required = true, value = "Indicativo de atributo obrigatorio ou não para captura.")
