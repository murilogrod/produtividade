...
@ApiModel(
        value = ConstantesNegocioSiric.API_MODEL_PROPOSTA_TOMADOR_RESPOSTA,
        description = "Objeto utilizado para representar resposta do tomador.")
public class PropostaTomadorRespostaDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesNegocioSiric.RESULTADO, required = true , value = "Objeto utilizado para representar os atributos de um Resultado Proposta Tomador.")
    private ResultadoPropostaTomadorDTO resultado;
    ...
    public ResultadoPropostaTomadorDTO getResultado() {
        return resultado;
    }

    public void setResultado(ResultadoPropostaTomadorDTO resultado) {
