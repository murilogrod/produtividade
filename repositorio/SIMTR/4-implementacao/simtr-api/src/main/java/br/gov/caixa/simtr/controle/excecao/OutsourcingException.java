...
public class OutsourcingException extends RuntimeException {
    ...
    public OutsourcingException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public OutsourcingException(String mensagem, Throwable causa, boolean servicoDisponivel) {
