...
public class SipesException extends RuntimeException {
    ...
    public SipesException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SipesException(String mensagem, Throwable causa, boolean servicoDisponivel) {
