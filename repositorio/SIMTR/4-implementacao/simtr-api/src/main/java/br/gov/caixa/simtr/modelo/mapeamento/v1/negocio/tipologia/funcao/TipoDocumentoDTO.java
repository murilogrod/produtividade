...
@ApiModel(
        value = ConstantesNegocioTipologia.VISAO_FUNCAO_API_MODEL_V1_TIPO_DOCUMENTO,
        description = "Objeto utilizado para representar o Tipo de Documento no contexto da Função Documental sob a visão da sustentação ao negócio."
)
