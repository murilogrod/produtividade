...
public class ProcessoDTO implements Serializable {
    ...
    @JsonProperty(value = ConstantesCadastroProcesso.IDENTIFICADOR_PROCESSO, required = true)
    @ApiModelProperty(name = ConstantesCadastroProcesso.IDENTIFICADOR_PROCESSO, required = true, value = "Atributo que representa a chave primária da entidade")
    private Integer id;
