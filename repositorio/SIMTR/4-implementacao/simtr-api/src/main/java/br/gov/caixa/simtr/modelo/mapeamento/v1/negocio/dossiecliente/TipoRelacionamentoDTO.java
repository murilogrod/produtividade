...
public class TipoRelacionamentoDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesNegocioDossieProduto.PRINCIPAL, required = true, value = "Indica se o tipo de relacionamento tem carater de atribuição imediata ao cliente contextualizado.")
