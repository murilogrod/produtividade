...
public class ProdutoDTO implements Serializable {
    ...
    @JsonProperty(value = ConstantesCadastroProduto.IDENTIFICADOR_PRODUTO, required = true)
    @ApiModelProperty(name = ConstantesCadastroProduto.IDENTIFICADOR_PRODUTO, required = true, value = "Atributo que representa a chave primária da entidade")
    private Integer id;
