...
public class SiisoException extends RuntimeException {
    ...
    public SiisoException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SiisoException(String mensagem, Throwable causa, boolean servicoDisponivel) {
