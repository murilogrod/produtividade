...
public final class ConstantesConsultaCampoFormulario {
    
   private ConstantesConsultaCampoFormulario() {}

    // ************* API MODEL *************
   // Identificadores de objetos na visão das operações de cadastro interno a plataforma
   public static final String API_MODEL_DEFINICAO_CAMPO_FORMULARIO = "cadastro.campoformulario.DefinicaoCampoFormularioDTO";
   

   // ************* XML Root *************
   public static final String XML_ROOT_CAMPO_FORMULARIO = "definicao_campo_formulario";
   ...
   public static final String IDENTIFICADOR_BPM = "identificador_bpm";
   ...
   public static final String OPCOES_CAMPO = "opcoes_campo";
   public static final String FORMAS_APRESENTACAO = "formas_apresentacao";
