...
public class SiecmException extends RuntimeException {
    ...
    public SiecmException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SiecmException(String mensagem, Throwable causa, boolean servicoDisponivel) {
