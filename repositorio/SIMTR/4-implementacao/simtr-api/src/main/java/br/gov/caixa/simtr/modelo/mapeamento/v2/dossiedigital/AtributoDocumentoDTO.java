package br.gov.caixa.simtr.modelo.mapeamento.v2.dossiedigital;
...
@XmlRootElement(name = ConstantesDossieDigitalAutorizacao.XML_ROOT_ELEMENT_ATRIBUTO_DOCUMENTO)
@XmlAccessorType(XmlAccessType.FIELD)
@JsonInclude(Include.NON_NULL)
@ApiModel(
          value = ConstantesDossieDigitalAutorizacao.API_MODEL_V2_ATRIBUTO_DOCUMENTO,
...
public class AtributoDocumentoDTO implements Serializable {
    ...
    @XmlElement(name = ConstantesDossieDigitalAutorizacao.CHAVE)
    @ApiModelProperty(name = ConstantesDossieDigitalAutorizacao.CHAVE, required = true, value = "Nome do atributo do documento", example = "nome")
    private String chave;

    @XmlElement(name = ConstantesDossieDigitalAutorizacao.VALOR)
    @ApiModelProperty(name = ConstantesDossieDigitalAutorizacao.VALOR, required = true, value = "Valor do atributo do documento no caso de atributos objetivos. Se utilizado o elemento \"opcoes_selecionadas\" não deve ser informado", example = "fulano de tal")
    private String valor;
    
    @JsonInclude(value = Include.NON_EMPTY)
    @XmlElement(name = ConstantesDossieDigitalAutorizacao.OPCAO_SELECIONADA)
    @XmlElementWrapper(name = ConstantesDossieDigitalAutorizacao.OPCOES_SELECIONADAS)
    @JsonProperty(value = ConstantesDossieDigitalAutorizacao.OPCOES_SELECIONADAS)
    @ApiModelProperty(name = ConstantesDossieDigitalAutorizacao.OPCOES_SELECIONADAS, required = false, value = "Valor da opção selecionada no caso de atributos objetivos. Se utilizado o elemento \"valor\" não deve ser informado")
