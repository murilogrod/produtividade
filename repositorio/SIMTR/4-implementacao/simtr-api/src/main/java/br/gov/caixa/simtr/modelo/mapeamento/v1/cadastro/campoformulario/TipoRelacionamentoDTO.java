...
@ApiModel(
        value = ConstantesCadastroCampoFormulario.API_MODEL_TIPO_RELACIONAMENTO,
        description = "Objeto utilizado para representar um tipo de relacionamento originador nas consultas realizadas sob a ótica dos cadastros")
public class TipoRelacionamentoDTO implements Serializable  {
    ...
    @ApiModelProperty(name = ConstantesCadastroCampoFormulario.NOME, required = true, value = "Atributo que identifica o tipo de relacionamento vinculado")
	private String nome;
	...
	public TipoRelacionamentoDTO(Integer id, String nome) {
		super();
		this.id = id;
		this.nome = nome;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		TipoRelacionamentoDTO other = (TipoRelacionamentoDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
