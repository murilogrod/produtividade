...
public class SimtrPermissaoException extends RuntimeException {
    ...
    public SimtrPermissaoException(String mensagem) {
        super(mensagem);
    }

    public SimtrPermissaoException(String mensagem, Throwable causa) {
