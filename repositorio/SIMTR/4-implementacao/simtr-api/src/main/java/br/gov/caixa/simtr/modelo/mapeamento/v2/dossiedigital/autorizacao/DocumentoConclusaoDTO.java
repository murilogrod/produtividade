package br.gov.caixa.simtr.modelo.mapeamento.v2.dossiedigital.autorizacao;
...
@ApiModel(
        value = ConstantesDossieDigitalAutorizacao.API_MODEL_V2_DOCUMENTO_CONCLUSAO,
...
public class DocumentoConclusaoDTO implements Serializable {
    ...
    @XmlElement(name = ConstantesDossieDigitalAutorizacao.MIMETYPE)
    @ApiModelProperty(name = ConstantesDossieDigitalAutorizacao.MIMETYPE, required = true, value = "Informação do mimetype do arquivo representado pelo binario encamoinhado")
