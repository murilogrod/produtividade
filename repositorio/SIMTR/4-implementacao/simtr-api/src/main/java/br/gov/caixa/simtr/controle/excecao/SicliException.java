...
public class SicliException extends RuntimeException {
    ...
    public SicliException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SicliException(String mensagem, Throwable causa, boolean servicoDisponivel) {
