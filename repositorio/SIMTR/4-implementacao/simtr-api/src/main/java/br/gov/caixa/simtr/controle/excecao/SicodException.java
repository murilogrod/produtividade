...
public class SicodException extends RuntimeException {
    ...
    public SicodException(String mensagem, boolean servicoDisponivel) {
        super(mensagem);
        this.servicoDisponivel = servicoDisponivel;
    }

    public SicodException(String mensagem, Throwable causa, boolean servicoDisponivel) {
