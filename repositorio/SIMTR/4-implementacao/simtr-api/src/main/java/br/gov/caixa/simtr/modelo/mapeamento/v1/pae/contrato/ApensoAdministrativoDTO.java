...
@ApiModel(
        value = ConstantesPAE.VISAO_CONTRATO_API_MODEL_APENSO_ADMINISTRATIVO,
        description = "Objeto utilizado para representar o Apenso Adminstrativo no retorno as consultas realizadas sob a otica da consulta pelo Contrato."
)
public class ApensoAdministrativoDTO implements Serializable {
    ...
    public ApensoAdministrativoDTO(ApensoAdministrativo apenso) {
        ...
        if (Objects.nonNull(apenso.getCpfCnpjFornecedor())) {
        ...
        if (Objects.nonNull(apenso.getDocumentosAdministrativos())) {
