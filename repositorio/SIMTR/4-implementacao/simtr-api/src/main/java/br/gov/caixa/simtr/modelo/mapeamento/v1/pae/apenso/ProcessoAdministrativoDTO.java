...
@ApiModel(
        value = ConstantesPAE.VISAO_APENSO_API_MODEL_PROCESSO_ADMINISTRATIVO,
        description = "Objeto utilizado para representar o Processo Adminstrativo no retorno as consultas realizadas sob a otica da consulta pelo Apenso."
)
public class ProcessoAdministrativoDTO implements Serializable {
    ...
    //TODO: c090347 - Substituir valor por NUMERO_PREGAO
    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    @XmlElement(name = ConstantesPAE.NUMERO_CONTRATACAO)
    @ApiModelProperty(name = ConstantesPAE.NUMERO_CONTRATACAO, allowEmptyValue = true, required = false, value = "Valor que representa o numero da contratação originado pelo Processo Administrativo.")
    private Integer numeroContratacao;

    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    @XmlElement(name = ConstantesPAE.UNIDADE_CONTRATACAO)
    @ApiModelProperty(name = ConstantesPAE.UNIDADE_CONTRATACAO, allowEmptyValue = true, value = "Valor que representa a unidade CAIXA responsável pela execução da contratação.")
    private Integer unidadeContratacao;

    @XmlElement(name = ConstantesPAE.UNIDADE_DEMANDANTE)
    @ApiModelProperty(name = ConstantesPAE.UNIDADE_DEMANDANTE, required = true, value = "CGC de unidade demandante.")
    private Integer unidadeDemandante;

    @JsonInclude(value = JsonInclude.Include.NON_NULL)
    @XmlElement(name = ConstantesPAE.ANO_CONTRATACAO)
    @ApiModelProperty(name = ConstantesPAE.ANO_CONTRATACAO, required = false, value = "Valor que representa o ano de execução da contratação.")
    ...
    public Integer getNumeroContratacao() {
        return numeroContratacao;
    }

    public void setNumeroContratacao(Integer numeroContratacao) {
