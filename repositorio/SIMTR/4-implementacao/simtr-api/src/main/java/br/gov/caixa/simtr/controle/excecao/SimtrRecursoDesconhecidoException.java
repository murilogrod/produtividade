...
public class SimtrRecursoDesconhecidoException extends RuntimeException {
    ...
    public SimtrRecursoDesconhecidoException(String mensagem) {
        super(mensagem);
    }

    public SimtrRecursoDesconhecidoException(String mensagem, Throwable causa) {
