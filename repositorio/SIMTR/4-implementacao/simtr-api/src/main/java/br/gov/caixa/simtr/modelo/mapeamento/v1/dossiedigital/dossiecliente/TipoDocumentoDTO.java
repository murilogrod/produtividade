...
@XmlRootElement(name = ConstantesDossieDigitalDossieCliente.XML_ROOT_ELEMENT_TIPO_DOCUMENTO)
@XmlAccessorType(XmlAccessType.FIELD)
@ApiModel(
          value = ConstantesDossieDigitalDossieCliente.API_MODEL_V1_TIPO_DOCUMENTO,
...
public class TipoDocumentoDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesDossieDigitalDossieCliente.ID, required = true, value = "Valor que identifica o Tipo de Documento")
    private Integer id;

    @XmlElement(name = ConstantesDossieDigitalDossieCliente.NOME)
    @ApiModelProperty(name = ConstantesDossieDigitalDossieCliente.NOME, required = true, value = "Valor que reprensenta o nome do Tipo de Documento")
    private String nome;
