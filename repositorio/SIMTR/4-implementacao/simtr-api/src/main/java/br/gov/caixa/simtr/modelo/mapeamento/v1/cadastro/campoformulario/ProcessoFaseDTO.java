...
@ApiModel(
        value = ConstantesCadastroCampoFormulario.API_MODEL_PROCESSO_FASE,
        description = "Objeto utilizado para representar um processo fase originador nas consultas realizadas sob a ótica dos cadastros")
public class ProcessoFaseDTO implements Serializable {
    ...
    @ApiModelProperty(name = ConstantesCadastroCampoFormulario.NOME, required = true, value = "Atributo que identifica o processo fase vinculado")
	private String nome;
	...
	public ProcessoFaseDTO(Integer id, String nome) {
		super();
		this.id = id;
		this.nome = nome;
	}
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ProcessoFaseDTO other = (ProcessoFaseDTO) obj;
		if (id == null) {
			if (other.id != null)
				return false;
