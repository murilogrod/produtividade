...
function Datepicker() {
	...
	this.regional[''] = { // Default regional settings
		...
		dayNames: ['Domingo','Segunda','Terça','Quarta','Quinta','Sexta','Sábado','Domingo'], // For formatting
		dayNamesShort: ['Dom','Seg','Ter','Qua','Qui','Sex','Sáb','Dom'], // For formatting
		dayNamesMin: ['D','S','T','Q','Q','S','S','D'], // Column headings for days starting at Sunday
