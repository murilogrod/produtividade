...
function fxPickListForm2($compile, $templateCache){
...
var fxPickListTpl=
	...
	"						<span class=\"glyphicon glyphicon-chevron-left\"> Remover </span>"+
	"					</button>"+
	"				</div>"+
	"			</div>"+
	"			<div style=\"display: table-cell; width: 40%;vertical-align: middle;\">"+
...
angular.module("fxpicklist2", [])
.directive("picklist2", fxPickList)
.directive("picklistForm2", fxPickListForm2)
.directive("picklistSrc", fxPickListSrc) 
.directive("picklistDest", fxPickListDest)
.run(["$templateCache", function($templateCache) {
	 $templateCache.put("picklist2.html", fxPickListTpl);
}]);